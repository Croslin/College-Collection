...
<body>
    ...
    //Use the name of the input database to connect to that one specifically
        ...
        ?>
        <h1> <u>Therpston County Library Catalog -Movies</u> </h1>
        <br>
        ...
        <button onclick="window.location.href='http://rajah.centre.edu/patron/PatronCatalogView.php';">
        Both
        </button>
